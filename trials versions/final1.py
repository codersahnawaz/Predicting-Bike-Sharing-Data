...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = output_errors * final_outputs * (1 - final_outputs)
        ...
        delta_weights_i_h += np.dot(hidden_errors.T * hidden_grad, inputs.T)
        
        # Weight step (hidden to output)        
        delta_weights_h_o += (output_errors * hidden_outputs).T
