...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        '''
        #features = np.array(inputs, ndmin=2).T
    ...
    def run(self, features):
        ...
        '''
        #fixing dimension error
        #inputs = np.array(features, ndmin=2).T
        #print('features' +str(features.shape[0])+'---' + str(features.shape[1])); 
        #### Implement the forward pass here ####
        ...
        final_inputs = np.dot(self.weights_hidden_to_output.T, hidden_outputs.T) # signals into final output layer
        final_outputs = final_inputs # signals from final output layer 
